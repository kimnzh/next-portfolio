...
const UnderDevelopment = () => {
  return (
    <main className="pt-[25vh] min-h-screen bg-gradient-to-br from-tertiary to-secondary flex-col flex items-center">
      <div className="w-48 md:w-64 aspect-square relative">
        <Image src={Logo} alt={"logo"} fill />
      </div>
      <div className="border-solid bg-primary border-white border-2 px-4 sm:px-10 py-2 sm:py-6 rounded-[16px] sm:rounded-[32px] text-lg sm:text-3xl lg:text-6xl text-white mt-12 font-semibold glowing-text">
