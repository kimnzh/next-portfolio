      ...
      <div className="relative w-full grid gap-6 md:gap-8 grid-cols-2 md:grid-cols-[1fr_2fr] bg-primary dark:bg-primary-dark border-2 border-primary-dark dark:border-white rounded-[24px] md:rounded-[36px] p-[42px_24px_24px] md:p-[56px_32px_32px]">
        <div className="relative">
          <input
            type="text"
            placeholder=""
            className="bg-white peer h-8 md:h-10 w-full text-lg py-2 px-3 rounded-[8px] md:rounded-[10px] border-2 border-primary-dark"
          />
        ...
        <div className="relative col-span-2 md:row-span-3 row-start-3 md:col-start-2 md:row-start-1">
          <textarea
            placeholder=""
            className="peer h-48 md:h-full w-full bg-white text-lg py-2 px-3 rounded-[8px] md:rounded-[10px] border-2 border-primary-dark"
          />
          <span className="placeholder">Message</span>
        </div>
        <button className="h-8 md:h-10 text-lg button border-2 rounded-[8px] md:rounded-[10px] max-md:col-span-2">
          Send
        </button>
