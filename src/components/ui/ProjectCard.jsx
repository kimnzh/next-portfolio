          ...
          <div className="flex flex-col xl:p-2">
            ...
            <div className="my-2 flex h-4 gap-1 sm:my-3 md:h-6 md:gap-2 lg:gap-4 xl:h-10">
              {data.stacks.map((stack, idx) => (
                ...
                >
                  <p className="absolute bottom-0 right-1/2 z-20 origin-center translate-x-1/2 scale-0 rounded-xl bg-primary px-2 py-0.5 font-semibold text-primary-dark transition group-hover:translate-y-10 group-hover:scale-100 max-xl:text-sm max-md:hidden">
                    {stack}
                  </p>
                  <Image
